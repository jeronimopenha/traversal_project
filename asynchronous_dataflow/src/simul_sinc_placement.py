...
def simul_sinc_placement(s_dot: str) -> Module:
...
if __name__ == '__main__':
    try:
        input_path = './bench/test_bench/sincrono/'
        placement_input_path = './exp_results/sincrono/placements/sa/mesh/1000/'
        verilog_output_path = './exp_results/sincrono/simulations/placement/sa/verilog/'
        results_output_path = './exp_results/sincrono/simulations/placement/results/'
        data_output_path = './exp_results/sincrono/simulations/placement/output/'
        files_l = []

        placement_files = {}
        for dir, folder, files in os.walk(placement_input_path):
            flag = False
            for f in files:
                flag = True
                files_l.append(
        ...
        for i in range(len(files_l)):
            m, file = simul_sinc_placement(files_l[i][0])
