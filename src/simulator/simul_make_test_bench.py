...
from src.simulator.simul_make_component import make_dataflow
import networkx as nx


def make_producer() -> Module():
    m = Module('producer')
...
def make_test_bench(file: str, dataflow_dot: nx.DiGraph()) -> Module():
